                ...
                <div className="text-center mb-6">
                    ...
                    <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1 mb-4">
                        <button
                            ...
                            className={`px-3 py-1 rounded text-sm font-medium transition-all ${gameMode === 'vs-human'
                        ...
                        <button
                            ...
                            className={`px-3 py-1 rounded text-sm font-medium transition-all ${gameMode === 'vs-ai'
                                ? 'bg-blue-600 text-white'
                                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'
                                }`}
                        >
                ...
                <div className="grid grid-cols-3 gap-2 mb-6 bg-gray-200 dark:bg-gray-700 p-2 rounded-lg">
                    {board.map((cell, index) => (
                        <motion.button
                            ...
                            className={`w-20 h-20 text-3xl font-bold rounded-lg transition-all duration-200 ${cell === 'X'
